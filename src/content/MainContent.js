    ...
    return(
        <div className="app__content">
            ...
            <div className="app__content product">
                <div className="app__content product__gallery">
                    <div className="app__content product__gallery image_selector">
                ...
                <div className="app__content product__description">
                    <h3>Best seller</h3>
                    <p>(1731 reviews)</p>
            ...
            <div className="app__content main_overview">
                <h1>Overview</h1>
                <h3>Who It's For</h3>
