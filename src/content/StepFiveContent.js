function StepFiveContent() {
    return(
        <div className="app__step_five">
            <img className="step_bar" src="/images/v_step_five.png" alt="step_5"/>
            <div className="info">
                <h1>Step 5</h1>
                <h1>Buy and Provide order ID to our Manager</h1>
                <p>Click the button GO TO AMAZON and Buy a Product</p>
                <button className="amazon_button">Go to amazon <img src="/images/amazon_ico.png"/></button>
