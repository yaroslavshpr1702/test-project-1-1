function StepTwoContent() {
    return(
        <div className="app__step_two">
            <img className="app__step_two step" src="/images/v_step_two.png" alt="step_2"/>
            <div className="info">
                <h1>Step 2</h1>
            ...
            <img src="/images/facebook_post.png" alt="bg_img"/>
            <img src="/images/press_here_block.png" alt="press_here_block_img"/>
        </div>
    )
}
